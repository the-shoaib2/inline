...
import { EventNormalizer } from '../../src/events/event-normalizer';
import { DiagnosticCollector } from '../../src/events/collectors/diagnostic-collector';
import { TerminalCollector } from '../../src/events/collectors/terminal-collector';
import { SyntaxSemanticEventType, UserInteractionEventType } from '../../src/events/event-types';

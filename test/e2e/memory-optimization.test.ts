...
import { MemoryManager } from '../../src/system/memory-manager';
import { CacheManager } from '../../src/core/cache/cache-manager';
import { ParallelProcessor } from '../../src/core/parallel-processor';
import { UserPatternDetector } from '../../src/analysis/user-pattern-detector';

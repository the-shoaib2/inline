...
export interface FileSystemEvent extends BaseEvent {
    ...
    uri: vscode.Uri;
    oldUri?: vscode.Uri; // For rename events
    isAutoSave?: boolean; // For save events
    isExternal?: boolean; // For external modifications
}
...
export enum CodeModificationEventType {
...
export enum CodeContextEventType {
...
export enum SyntaxSemanticEventType {
...
export enum SessionStateEventType {

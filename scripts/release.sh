...
update_changelog() {
    ...
    if [ -f "CHANGELOG.md" ]; then
        ...
        /## Release Catalog/ {
            ...
            print "|---------|--------------|------|--------|----------|"
            print "| " version " | " date " | Release | Stable | [Download](https://github.com/inline-ai/inline/releases/tag/v" version ") |"
...
update_catalog() {
    ...
    if [ -f "CATALOG.md" ]; then
        ...
        /## Release History/ {
            ...
            print "- **Source Code**: [v" version "](https://github.com/inline-ai/inline/releases/tag/v" version ")"
            print ""
            print "---"
            print ""
            next

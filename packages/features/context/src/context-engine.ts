...
import { SemanticAnalyzer, LanguageConfigService } from '@inline/language';
import { 
    DecoratorInfo, GenericInfo, 
    EditHistory, CursorIntent, ProjectConfig, CodingPattern, StyleGuide, CodeContext, RelatedCodeBlock,
    FunctionInfo, ImportInfo, SymbolInfo, TypeInfo, InterfaceInfo, ClassInfo, ScopeInfo, DependencyInfo, VariableInfo,
    ParameterInfo, PropertyInfo
} from '@inline/shared';

// Re-export common types for internal usage
export { 
    DecoratorInfo, GenericInfo,
    EditHistory, CursorIntent, ProjectConfig, CodingPattern, StyleGuide, CodeContext, RelatedCodeBlock,
    FunctionInfo, ImportInfo, SymbolInfo, TypeInfo, InterfaceInfo, ClassInfo, ScopeInfo, DependencyInfo, VariableInfo,
...
import { ContextWindowBuilder } from './builders/context-window-builder';

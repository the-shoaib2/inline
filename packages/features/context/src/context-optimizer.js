...
class ContextOptimizer {
    constructor() {
        this.logger = new logger_1.Logger('ContextOptimizer');
    }
    /**
     ...
     */
    optimize(context, maxTokens = 2048) {
     ...
     */
    selectRelevant(context, cursorPosition, maxTokens) {
     ...
     */
    calculateRelevance(line, lineIndex, cursorLine) {
        let score = 0;

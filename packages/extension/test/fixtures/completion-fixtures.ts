...
export const COMPLETION_FIXTURES = {
    typescript: {
        functionFromComment: {
 ...
 */
export function getFixture(language: string, scenario: string): CompletionFixture | null {
    const langFixtures = COMPLETION_FIXTURES[language as keyof typeof COMPLETION_FIXTURES];
    if (!langFixtures) {
        return null;
    }
    
    return langFixtures[scenario as keyof typeof langFixtures] || null;
}

/**
 * Get all fixtures for a language
 */
export function getLanguageFixtures(language: string): Record<string, CompletionFixture> | null {
    return COMPLETION_FIXTURES[language as keyof typeof COMPLETION_FIXTURES] || null;
}
...
export function getSupportedLanguages(): string[] {
    return Object.keys(COMPLETION_FIXTURES);
}

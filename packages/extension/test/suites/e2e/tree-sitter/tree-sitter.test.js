...
const semantic_analyzer_1 = require("@inline/language/analysis/semantic-analyzer");
suite('Tree-sitter E2E Tests', () => {
    let treeSitterService;
    ...
    suiteSetup(async function () {
        ...
        treeSitterService = tree_sitter_service_1.TreeSitterService.getInstance();

...
suite('Model Import E2E Test', () => {
    ...
    test('Should validate and import GGUF model', async () => {
        ...
        try {
            ...
            const found = models.find((m) => m.id === importedModel.id);
            ...
            const foundDownloaded = downloadedModels.find((m) => m.id === importedModel.id);
...
//# sourceMappingURL=model-import.test.js.map
...
exports.runGeneratorTests = runGeneratorTests;
...
const sql_generator_1 = require("@inline/completion/generation/sql-generator");
const mock_data_generator_1 = require("@inline/completion/generation/mock-data-generator");
const regex_generator_1 = require("@inline/completion/generation/regex-generator");
const dto_generator_1 = require("@inline/completion/generation/dto-generator");
const boilerplate_generator_1 = require("@inline/completion/generation/boilerplate-generator");
const config_generator_1 = require("@inline/completion/generation/config-generator");
...
async function testCRUDGenerator() {
    ...
    const generator = new crud_generator_1.CRUDGenerator({});
...
function testAPIGenerator() {
    ...
    const generator = new api_generator_1.APIGenerator();
    // Test Express API
...
function testSQLGenerator() {
    ...
    const generator = new sql_generator_1.SQLGenerator();
    // Test CREATE TABLE
...
function testMockDataGenerator() {
    ...
    const generator = new mock_data_generator_1.MockDataGenerator();
...
function testRegexGenerator() {
    ...
    const generator = new regex_generator_1.RegexGenerator();
    // Test email regex
...
function testDTOGenerator() {
    ...
    const generator = new dto_generator_1.DTOGenerator();
    // Test TypeScript DTO
...
function testBoilerplateGenerator() {
    ...
    const generator = new boilerplate_generator_1.BoilerplateGenerator();

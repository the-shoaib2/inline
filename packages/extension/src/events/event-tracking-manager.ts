...
import { EventBus, getEventBus, disposeEventBus } from '@events/event-bus';
import { EventNormalizer } from '@events/event-normalizer';
import { FileSystemCollector } from '@events/collectors/file-system-collector';
import { EditorCollector } from '@events/collectors/editor-collector';
import { CodeModificationCollector } from '@events/collectors/code-modification-collector';
import { UserInteractionCollector } from '@events/collectors/user-interaction-collector';
import { PerformanceEventCollector } from '@events/collectors/performance-event-collector';
...
import { AIContextTracker } from '@events/trackers/ai-context-tracker';
import { VCSEventTracker } from '@events/trackers/vcs-event-tracker';
import { SessionStateTracker } from '@events/trackers/session-state-tracker';
...
import { ContextEnricher } from '@context/builders/context-enricher';
import { OptimizationLayer } from '@intelligence/optimization/optimization-layer';
import { EventStorage } from '@storage/tracking/event-storage';
import { FeedbackLoop } from '@context/analysis/feedback-loop';

...
import { ErrorExplainer } from '@language/analysis/error-explainer';
import { SecurityScanner } from '@language/analysis/security-scanner';
import { PRGenerator } from '@completion/generation/pr-generator';
...
import { RefactoringEngine } from '@language/analysis/refactoring-engine';
